...
$auth_users = array(
    'x_admin' => '$2y$10$bClevhjXjIMyWs0n4lNUy.vEh0SX6lsrwwV5a.TzQpdoFnrvvcZCy', //admin@123
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            <img src="/storage/photos/1/tradexpert.png" alt="">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Microxen</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="#" target="_blank" class="app-v-title"> File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: Ashik Kaiser</p>
                        <p>Mail Us: <a href="mailto:ashikkaiser@gmail.com">ashikkaiser[at]gmail.com</a> </p>
                    </div>
...
?>
    ...
    <head>
        ...
        <meta name="author" content="Ashik Kaiser">
